...
F2 <- read.csv(url('https://raw.githubusercontent.com/SexVar/Section-I/main/Table%20S1.csv'))
F3 <- read.csv(url('https://raw.githubusercontent.com/SexVar/Section-I/main/Table%20S2.csv'))
F4 <- read.csv(url('https://raw.githubusercontent.com/SexVar/Section-I/main/Table%20S3.csv'))
